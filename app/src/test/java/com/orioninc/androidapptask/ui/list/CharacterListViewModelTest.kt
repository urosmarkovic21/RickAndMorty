...
class CharacterListViewModelTest {
    ...
    fun `loadFirstPage success updates state`() = runTest {
        ...
        fakeRepository.charactersPage1 = listOf(
    ...
    fun `pagination adds new characters`() = runTest {
        ...
        fakeRepository.charactersPage2 = listOf(
        ...
        assert(state.characters == fakeRepository.charactersPage1 + fakeRepository.charactersPage2)
        assert(state.errorMessage == null)
    }
